...
A fresh real user is registered through the public /auth/register endpoint.
    ...
    scripts/generate_real_dev_activity.py [--attempts N] [--api 8080]

Prerequisites: the real dev stack up (scripts/dev_up.sh) + free MQTT command
delivery to the simulator (broker already running at :1884).
"""
...
def main() -> None:
    ...
    parser.add_argument("--api", type=int, default=8080,
