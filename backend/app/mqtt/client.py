...
Topic contract (see docs/mqtt-contract.md):
  ...
  ecoloop/stations/{code}/state      station -> backend
  ecoloop/stations/{code}/sensor     station -> backend
  ecoloop/stations/{code}/event      station -> backend
  ecoloop/stations/{code}/heartbeat  station -> backend
"""
